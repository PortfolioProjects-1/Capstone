...
x_tract <- arima(TN_Tract_Test$Population, order=c(0,2,2))
...
y_county$Year <- c("2017", "2018","2019","2020", "2021")
...
x1 <- arima(TN_County_Test$Population, order=c(1,1,2))
#print(x)
...
x2 <- arima(TN_Tract_Test$Population, order=c(1,1,0))
...
fit<-auto.arima(TN_Tract_Test$Population, seasonal=FALSE)
